...
const darkerBaseColors = {
	...
	black: "hsl(180, 5%, 9%)",
	accentBlue: baseColors.accentBlue,
...
const darkerBaseScaleColors = {
	...
	accentBlue: {
		base: darkerBaseColors.accentBlue,
		transparent: chroma(darkerBaseColors.accentBlue).alpha(0.6).hex(),
		dark: alpha(darken(darkerBaseColors.accentBlue, 0.8), 0.6),
		scale: [
			chroma(darkerBaseColors.accentBlue).brighten(0.1).hex(),
			chroma(darkerBaseColors.accentBlue).brighten(0.2).hex(),
			chroma(darkerBaseColors.accentBlue).brighten(0.3).hex(),
			chroma(darkerBaseColors.accentBlue).brighten(0.4).hex(),
		],
	},
	red: {
...
const darkerColors = {
	accent: darkerBaseScaleColors.accentBlue,
	border: {
