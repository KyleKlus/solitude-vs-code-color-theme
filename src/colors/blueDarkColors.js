...
const darkBaseScaleColors = {
	...
	accentBlue: {
		base: darkBaseColors.accentBlue,
		transparent: chroma(darkBaseColors.accentBlue).alpha(0.6).hex(),
		dark: alpha(darken(darkBaseColors.accentBlue, 0.8), 0.6),
		scale: [
			chroma(darkBaseColors.accentBlue).brighten(0.1).hex(),
			chroma(darkBaseColors.accentBlue).brighten(0.2).hex(),
			chroma(darkBaseColors.accentBlue).brighten(0.3).hex(),
			chroma(darkBaseColors.accentBlue).brighten(0.4).hex(),
		],
	},
	red: {
...
const darkColors = {
	accent: darkBaseScaleColors.accentBlue,
	border: {
